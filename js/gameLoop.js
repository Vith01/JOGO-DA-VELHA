...
function rodada(sqr){
	if(sqr.value == EMPTY_val){
		if(turno==1){
			sqr.value = X_val;
			sqr.style.backgroundImage = "url('image/joao_doria.jpg')";
			sqr.style.color = "#ffffff";
		}else{
			sqr.value = O_val;
			sqr.style.backgroundImage = "url('image/Comunismo.png')";
		}
		turno = turno*(-1);
		validaJogada();
	}
...
function validaJogada(){
	...
	(sqr7 == valorTurno && sqr5 == valorTurno && sqr3 == valorTurno) 
		...
		if (valorTurno == O_val){
			alert("O Comunismo ganhou");
			reset();
		}
		
		else if (valorTurno == X_val){
			alert("O Capitalismo ganhou, porém perdeu, pois ele é ruim");
			reset();
		}
	}else{
		if(sqr1 != EMPTY_val){
...
function reset(){
	...
	document.gameLoop.sqr1.style.backgroundColor = "purple";
	document.gameLoop.sqr2.style.backgroundColor = "purple";
	document.gameLoop.sqr3.style.backgroundColor = "purple";
	document.gameLoop.sqr4.style.backgroundColor = "purple";
	document.gameLoop.sqr5.style.backgroundColor = "purple";
	document.gameLoop.sqr6.style.backgroundColor = "purple";
	document.gameLoop.sqr7.style.backgroundColor = "purple";
	document.gameLoop.sqr8.style.backgroundColor = "purple";
	document.gameLoop.sqr9.style.backgroundColor = "purple";
